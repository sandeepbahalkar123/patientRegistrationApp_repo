...
public class FlowLayout extends ViewGroup {
    ...
    private final ArrayList<ArrayList<View>> mLines = new ArrayList<ArrayList<View>>();
    private final ArrayList<Integer> mLineHeights = new ArrayList<Integer>();
    private final ArrayList<Integer> mLineMargins = new ArrayList<Integer>();
